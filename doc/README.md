...
| [sound-devices.md](sound-devices.md) · [color-coded HTML](https://thk4711.github.io/raspberry-kitchen-radio/sound-devices.html) | Every selectable sound device, with a complete color-coded 40-pin map, compatibility actions, routing, and qualification. The HTML version (published to GitHub Pages by [`../.github/workflows/pages.yml`](../.github/workflows/pages.yml)) tints each pin description by owning subsystem. |
